            ...
            <motion.div
                ...
                {cardState === "yesResponse" && (
                    <QuestionCard
                        key="yes-response"
                        emoji="🩷"
                        question="Yesss! You always make my heart smile! I’m so lucky to have you in my life You are my princesa my everything annie g i love u sooo muxh Happy Birthday meri jan May allah live u long but just with me."
                        showButtons={false}
                ...
                {cardState === "finalNoResponse" && (
                    <QuestionCard
                        ...
                        emoji="🥺"
                        question="Oh no! You can't really say no to this! You're already mine Samjhi naw ap. Go back and make the right choice! means yesh"
                        showButtons={false}
                        btnText="Go back"
